...
There are just two lines needed to run the container using a Flox environment
...
After running a `flox push` for `flox/quotes-app`, restarting a pod will pull
the latest generation of the environment.
