...
## Install Flox
Download and install Flox following the [installation instructions][install-flox).
...
Once the shell is available, you should see `flox [default]` prepended to your shell prompt. You can also verify that your default environment is active by running [`flox envs`][envs]:
